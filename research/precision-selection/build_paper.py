...
p('WORKING PAPER v0.1 | 19 September 2026 | Not peer reviewed','SmallPaper')
p(TITLE,'PaperTitle')
p('Tanay Anand<br/>Independent project | tanayanand.me','BodyPaper')
