...
\begin{figure}[htbp]\centering\includegraphics[width=\linewidth]{selection-curves.png}\caption{Left: selected-answer accuracy with pointwise 95\% question-bootstrap bands; the dotted curve is answer availability. Right: disagreement with the native model. Constructed pools; 80 held-out questions.}\end{figure}
...
\begin{figure}[htbp]\centering\includegraphics[width=\linewidth]{replication-1.5b/selection-curves.png}\caption{Same-family 1.5B extension, on the same 80 held-out questions. Candidate construction and numerical backend limits remain unchanged.}\end{figure}
...
The manuscript received private review from colleagues. Codex assisted with research scoping, literature retrieval, implementation, local experiment execution, analysis, writing, and manuscript preparation.
